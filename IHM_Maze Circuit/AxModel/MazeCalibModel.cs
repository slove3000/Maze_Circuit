...
namespace AxModel
{
    public class MazeCalibModel : aXdataModel
    {
        #region Fields
        ...
        public MazeCalibModel(ushort x, ushort y, UniBiCodes uB)
        {
            this.x = x;
            this.y = y;
            this.uniBi = uB;
        ...
        public FrameExerciceDataModel MakeFrame()
        {
            ...
            yLSB = (byte)this.y;
            frame = new FrameExerciceDataModel(ConfigAddresses.modMazeCalib, xMSB, xLSByMSB, yLSB, (byte)this.uniBi);
